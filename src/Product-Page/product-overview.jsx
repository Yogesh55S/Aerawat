          ...
          <div className="mt-10 space-y-4 border-t-1 border-gray-300 pt-3 ">
            <details className="group">
              <summary className="font-medium text-gray-800 cursor-pointer flex justify-between items-center border-b-1 border-gray-300 pb-3">
                Buying Options
                <span className="group-open:rotate-45 transform transition-transform"><FaPlus /></span>
              </summary>
              <p className="text-gray-600 mt-2 pl-4  border-b-1 border-gray-300 pb-3">Choose from EMI or cash on delivery.</p>
            </details>
            <details className="group">
              <summary className="font-medium text-gray-800 cursor-pointer flex justify-between items-center  border-b-1 border-gray-300 pb-3">
              ...
              <p className="text-gray-600 mt-2 pl-4  border-b-1 border-gray-300 pb-3">Free returns within 10 days.</p>
            </details>
          </div>
        </div>
      </div>
